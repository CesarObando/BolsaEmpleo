<%-- 
    Document   : verVacantes
    Created on : Jul 28, 2014, 4:31:58 PM
    Author     : ricardo
--%>
...
<html lang="es" >
    <head>
        ...
        <title>Vacantes | Bolsa de Empleo</title>  
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form action="VerVacantes" method="post" enctype="multipart/form-data">
                        <s:textfield name="palabraClave" label="Buscar"/> 
                        <s:select label="Provincia"
                                  headerKey="-1" 
                                  list="provincias" 
                                  name="vacante.provincia" />
                        <s:select label="Categoria"
                                  headerKey="-1" 
                                  list="categorias" 
                                  name="vacanteCategoria" />
                        <s:submit key="Buscar" action="buscarVacante"/>


                        <table id="tablaVacante">
                            <tr>
                                <td>Descripción</td>
                            ...
                            <s:iterator value="vacantes">
                                <tr>
                                    <td><s:property value="descripcion"/></td>
                                    <td><s:property value="requerimientos"/></td>
                                    <td><s:property value="numeroVacantes"/></td>
                                    <td><s:property value="diasLaborar"/></td>  
                                    ...
                                    <td><a href='VerVacante?idPuesto=<s:property value="idPuesto"/>'><s:property value="idPuesto"/></a></td> 
                                </tr>
                            </s:iterator>
                        </table> 
                    </s:form>
