...
<html lang="es" >
    <head>
        ...
        <script type="text/javascript">
            function elegirEmpresa(value) {
               window.location = "actualizarCamposEmpresa?cedulJuridica=" + value;
            }
        </script>
    </head>
    <body>
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form method="post" enctype="multipart/form-data" action="listaEmpresas">
                        <s:select name="cedulJuridica" label="Empresas " 
                                  headerKey="-1" headerValue="--- Lista de empresas ---" 
                                  list="contactosEmpleadores" listKey="cedulaJuridica" listValue="empresa"
                                  onchange="elegirEmpresa(this.value)"/>
                        <s:textfield name="contactoEmpleador.cedulaJuridica" label="Cédula "/>
                        <s:textfield name="contactoEmpleador.empresa" label="Empresa "/>
                        <s:textfield name="contactoEmpleador.desingnacion" label="Designación "/>
                        <s:textfield name="contactoEmpleador.telefono" label="Telefono "/>
                        <s:textfield name="contactoEmpleador.extension" label="Extensión "/>
                        <s:textfield name="contactoEmpleador.fax" label="Fax "/>
                        <s:textfield name="contactoEmpleador.email" label="Email "/>
                        <s:submit action="borrarEmpresa" value="Borrar"/>
                        <s:submit action="modificarEmpresa" value="Modificar"/>              
                    </s:form>
