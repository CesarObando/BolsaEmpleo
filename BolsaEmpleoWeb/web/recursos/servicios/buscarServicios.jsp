...
<%-- 
    Document   : buscarServicios
    Created on : Jul 17, 2014, 11:26:54 PM
    Author     : ricardo
--%>
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form action="ServiciosBuscar" method="post" enctype="multipart/form-data">
                        <s:textfield name="palabraClave" label="Buscar"/> 
                        <s:select label="Provincia"
                                  headerKey="-1" 
                                  list="provincias" 
                                  name="servicio.provincia" />
                        <s:submit key="Buscar" action="buscarServicio"/>
