<%-- 
    Document   : curriculo
    Created on : Oct 22, 2014, 8:19:19 PM
    Author     : ricardo
--%>
...
<html lang="es" >
    <head>
        ...
        <title>Curriculum | Bolsa de Empleo</title>  
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <h1>¿Cómo hacer un currículo?</h1>

                    Aquí te ofrecemos una plantilla básica de un currículo. Solo descárgalo y llenalo con tus datos.<br>
                    <a href="./recursos/curriculo/Plantilla.doc">Plantilla Básica</a><br>
                    <br><br>
                    Y aquí hay un ejemplo por si ocuparas guiarte un poco. A este también le puedes sobreescribir los datos.<br>
                    <a href="./recursos/curriculo/Ejemplo.doc">Ejemplo</a>

                    <br><br><br>
                    O si necesitas más tipos de currículo, más especializados o de diferentes tipos, puedes visitar la siguiente página<br>
                    <a href="http://www.modelos-de-curriculum.com/plantillas-curriculum-3.php">Currículos Vitae</a>
