...
<html lang="es" >
    <head>
        ...
        <title>Borrar Servicio | Bolsa de Empleo</title>  
        ...
        <link rel="stylesheet" href="recursos/css/datetimepicker.css"/>
        ...
        <script type="text/javascript">
            function elegirServicio(value) {
                window.location = "actualizarInfoServicio?idServ=" + value;
            }
        </script>
    </head>
    <body>
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form method="post" enctype="multipart/form-data" action="listaServicios">
                        <s:select name="idServ" label="Servicios " 
                                  headerKey="-1" headerValue="--- Lista de servicios ---" 
                                  list="servicios" listKey="idServicio" listValue="nombre"
                                  onchange="elegirServicio(this.value)"/>
                        <s:textfield name="servicio.nombre" label="Cédula "/>
                        <s:textfield name="servicio.descripcion" label="Descripción "/>
                        <s:textfield name="servicio.telefono" label="Telefono "/>
                        <s:textfield name="servicio.correo" label="Correo "/>
                        <s:textfield name="servicio.provincia" label="Provincia "/>
                        <s:textfield name="servicio.ciudad" label="Ciudad "/>
                        <s:textfield name="servicio.direccion" label="Dirección "/>
                        <s:submit action="borrarServicio" value="Borrar"/>
                    </s:form>
