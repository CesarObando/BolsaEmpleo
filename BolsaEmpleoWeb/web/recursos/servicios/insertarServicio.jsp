<%-- 
    Document   : insertarServicio
    Created on : Jul 14, 2014, 1:43:42 AM
    Author     : ricardo
--%>
...
<html lang="es" >
    <head>
        ...
        <title>Mis Servicios | Bolsa de Empleo</title>  
        ...
        <script type='text/javascript'>
            function cambio(value) {
                window.location = "Servicios?servicio.idServicio=" + value; //or you can submit a form from here or make an ajax call
            }


            window.addEventListener("load", function () {
                var elem0 = document.getElementById('idServ');
                var elem = document.getElementById('actualizar');
                var elem2 = document.getElementById('eliminar');
                var elem3 = document.getElementById('ingresar');
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form method="post" enctype="multipart/form-data" action="Servicios">

                        <s:select name="servicio.idServicio" label="Sus Servicios" 
                                  headerKey="-1" headerValue="--- Nuevo Servicio ---" 
                                  list="serviciosUsuario" listKey="idServicio" 
                                  listValue="nombre" onchange="cambio(this.value)" id="idServ"/>


                        <s:textfield name="servicio.nombre" label="Nombre"/>
                        <s:textarea name="servicio.descripcion" label="Descripción"/>
                        <s:textfield name="servicio.telefono" label="Teléfono"/>
                        <s:textfield name="servicio.correo" label="Correo"/>
                        <s:textfield name="servicio.direccion" label="Dirección"/> 

                        <!--revisar por que dos selects dan error-->
                        <%--<s:select name="servicio.provincia" label="Provincia"--%> 
                        <!--headerKey="-1" headerValue="---Seleccione provincia---"-->
                        <!--list="provincias"-->
                        <!--name="servicio.provincia" />-->  

                        <s:textfield name="servicio.ciudad" label="Ciudad"/>

                        <s:submit action="actualizarServicio" id="actualizar" value="Actualizar"/>
                        <s:submit action="eliminarServicio" id="eliminar" value="Eliminar"/>
                        <s:submit action="insertarServicio" id="ingresar" value="Ingresar"/>
