                                        ...
                                        <s:iterator value="administradores" var="administradorActual">
                                            <tr class="tr">
                                                ...
                                                <td><p data-placement="top" data-toggle="tooltip" title="Delete">
                                                        ...
                                                        <a href='<s:property value="#url" />' onclick="return confirmBox('¿Desea eliminar al administrador?');">  <button style="background-color: transparent"><img src="../imagenes/eliminar.png"/></button> </a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </s:iterator>
