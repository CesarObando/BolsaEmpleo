                                        ...
                                        <s:iterator value="solicitantes" var="solicitanteActual">
                                            <tr class="tr">
                                                ...
                                                <td><p data-placement="top" data-toggle="tooltip" title="Delete">
                                                        ...
                                                        <a href='<s:property value="#url" />' onclick="return confirmBox('¿Desea eliminar al solicitante?');">  <button style="background-color: transparent"><img src="../imagenes/eliminar.png"/> </button> </a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </s:iterator>
