            ...
            <div id="zone-content" class="clearfix container-12">  
                ...
                <aside class="grid-3 region" id="region-sidebar-second">
                    <div class="grid-9 region-content" id="region-content">
                        ...
                        <s:form method="post" action="insertarSolicitanteProcess" enctype="multipart/form-data" cssClass="form" style="align:center">
                            ...
                            <center><a href="../usuarios/pantallaPrincipal.jsp" style="height: 10px;background: transparent">Cancelar</a></center>
                            <script>
                                function confirmBox() {
                                    var answer;
