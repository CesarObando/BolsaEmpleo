<%-- 
    ...
    Created on : Jul 26, 2014, 11:19:18 PM
    Author     : ricardo
--%>
...
<html lang="es" >
    <head>
        ...
        <title>Experiencia | Bolsa de Empleo</title>  
            ...
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form method="post" enctype="multipart/form-data" action="EspecialidadesOferente">
                        ...
                        <s:textfield name="empresa" label="Nombre Empresa" onClick="this.select();"/>
                        <s:textfield name="puesto" label="Puesto" onClick="this.select();"/>

                        <sj:datepicker name="fechaIngreso" label="Fecha Ingreso"  displayFormat="dd/mm/yy"></sj:datepicker>
                        <sj:datepicker name="fechaTermina" label="Fecha Fin"  displayFormat="dd/mm/yy"></sj:datepicker>
                        <s:label value="En blanco para indicar que todavía trabaja en dicha empresa"/>

                        <s:textarea name="descripcionFunciones" label="Describa funciones" onClick="this.select();"/> 

                        <s:submit action="agregarExperiencia" value="Agregar experiencia"/>
                        ...
                        <table id="tablaEspecialidades">
                            ...
                            <s:iterator value="oferente.experienciasLaborales">
                                <tr>
                                    <td><s:property value="empresa"/></td>
                                    <td><s:property value="puesto"/></td>
                                    <td><s:property value="fechaIngreso"/></td>
                                    <td><s:property value="fechaTermina"/></td>  
                                    <td><s:property value="descripcionFunciones"/></td> 
                                    <td><a href='quitarExperiencia?value=<s:property value="idExperiencia"/>'><s:property value="idExperiencia"/></a></td> 
                                </tr>
                            </s:iterator>
                        </table>
                    </s:form>
