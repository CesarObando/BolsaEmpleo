...
<html lang="es" >
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                elegirEmpleador('vacia');
            });
            function elegirEmpleador(value) {
                window.location = "actualizarCamposEmpleador?cedul=" + value;
            }
    ...
    <body>
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form method="post" enctype="multipart/form-data" action="listaEmpleadores">
                        <s:select name="cedul" label="Empleadores " 
                                  headerKey="-1" headerValue="--- Lista de empleadores ---" 
                                  list="empleadores" listKey="cedula" listValue="nombre"
                                  onchange="elegirEmpleador(this.value)"/>
                        <s:textfield name="empleador.cedula" label="Cédula "/>
                        <s:textfield name="empleador.nombre" label="Nombre "/>
                        <s:textfield name="empleador.apellidos" label="Apellidos "/>
                        <s:select list="provincias" id="provincia" name="empleador.provincia" label="Provincia " onchange="cambiarCiudades()"/>
                        <s:select list="ciudades" id="ciudad" name="empleador.ciudad" label="Ciudad "/>
                        <s:textfield name="empleador.direccion" label="Dirección "/>
                        <s:textfield name="empleador.codigoPostal" label="Cód. Postal "/>
                        <s:textfield name="empleador.email" label="E-mail "/>
                        <s:textfield name="empleador.telefonoCasa" label="Tél. Hogar " onkeypress="return soloNumeros(event);"/>
                        <s:textfield name="empleador.telefonoCelular" label="Tél celular " onkeypress="return soloNumeros(event);"/>
                        <s:textfield name="empleador.fax" label="Fax " onkeypress="return soloNumeros(event);"/>
                        <s:textfield name="fechaNacimientoString" id="fechaNacimiento" label="Fecha de nacimiento "/>                            
                        <s:submit action="actualizarCuentaEmpleador" value="Actualizar"/>                                   
                        <s:submit action="borrarEmpleador" value="Borrar"/>
       ...
       <c:if test="${sessionScope.empleador!=null}">
        ...
        <script src="recursos/js/datetimepicker.js"></script>
