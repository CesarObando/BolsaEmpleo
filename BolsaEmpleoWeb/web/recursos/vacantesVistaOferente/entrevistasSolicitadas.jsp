<%-- 
    Document   : entrevistasSolicitadas
    Created on : Jul 28, 2014, 9:15:40 PM
    Author     : ricardo
--%>
...
<html lang="es" >
    <head>
        ...
        <title>Entrevistas | Bolsa de Empleo</title>  
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form method="post" enctype="multipart/form-data" action="EntrevistasSolicitadas">
                        ...
                        <table id="tablaEspecialidades">
                            ...
                            <s:iterator value="vacantes">
                                <tr>
                                    ...
                                    <td><a href='cancelarEntrevista?idPuesto=<s:property value="idPuesto"/>'>X</a></td> 
                                </tr>
                            </s:iterator>
                        </table> 
                    </s:form>
