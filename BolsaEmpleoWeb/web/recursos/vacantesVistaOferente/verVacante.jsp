<%-- 
    Document   : verVacante
    Created on : Jul 28, 2014, 7:46:04 PM
    Author     : ricardo
--%>
...
<html lang="es" >
    <head>
        ...
        <title>Vacante | Bolsa de Empleo</title>  
        ...
        <script type='text/javascript'>
            window.addEventListener("load", function () {
                ...
                var elem = document.getElementById('sol');
                var elem2 = document.getElementById('botonSE');
                var elem3 = document.getElementById('teSE');
        ...
        <section >
            <div id="zone-content" class="clearfix container-12">    
                ...
                <div class="grid-9 region-content" id="region-content">
                    ...
                    <s:form method="post" enctype="multipart/form-data" action="VerVacante">
                        <s:textfield name="sol" disabled="true" id="sol"/>

                        <s:textfield name="descripcion" label="Descripción" readonly="true"/>
                        <s:textarea name="requerimientos" label="Requerimientos" readonly="true"/>
                        <s:textfield name="numeroVacantes" label="Núm Vacantes" readonly="true"/>
                        <s:textfield name="diasLaborar" label="Dias Laborar" readonly="true"/>
                        <s:textfield name="horaEntrada" label="Hora Entrada" readonly="true"/> 
                        <s:textfield name="horaSalida" label="Hora Salida" readonly="true"/>
                        <s:textfield name="sueldo" label="Sueldo" readonly="true"/>
                        <s:textfield name="provincia" label="Provincia" readonly="true"/>
                        <s:textfield name="ciudad" label="Ciudad" readonly="true"/>
                        <s:textfield name="categoria.nombre" label="Categoria" readonly="true"/>

                        <s:submit action="solicitarEntrevista" id="botonSE" value="Solicitar Entrevista"/>
                        <s:label id="teSE" value="Usted ya ha solicitado por esta vacante"></s:label>
