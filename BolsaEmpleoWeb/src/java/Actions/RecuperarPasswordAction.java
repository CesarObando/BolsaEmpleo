 ...
 * @author Cesar
 */
public class RecuperarPasswordAction extends ActionSupport implements Preparable, ModelDriven<Solicitante>, ServletRequestAware, SessionAware {
    ...
    public String recuperarPassword() {
        ...
        try {
            ...
            enviaCorreo.EnviarCorreo(solicitante.getCorreo(), "Solicitud de recuperación de contraseña", "Se recibio una solicitud para la recuperacion de la contraseña del usuario: "+ solicitante.getUsername() + " la contraseña es: " +solicitante.getPassword());
